...
安装vite-plugin-vue-setup-extend  可以在vue3中修改组件名，使得开发工具呈现出你修改的组件名。

未安装前实现：需要用两个script标签实现
...
```vue	
<script  setup lang="ts" name="Person245">
let name='3333'
</script>
<template>
  <div>哈哈哈哈{{ name }}</div>
...
![image-20240330133604591](D:/typora_photo/image-20240330133604591.png)
